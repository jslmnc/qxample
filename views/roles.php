									...
									<div class="col-md-4">
										...
										<div class="card card-flush h-md-100">
											...
											<div class="card-body pt-1">
												...
												<div class="fw-bolder text-gray-600 mb-5">Total users with this role: <?php echo getcount($dbh,$result->rolename)?>
											...
											<div class="card-footer flex-wrap pt-0">
												<a href="rolesview?rolename=<?php echo htmlentities($result->rolename);?>" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
												...
												<button type="button" onclick="deleterole(<?php echo htmlentities($result->id);?>)" class="btn btn-light btn-active-light-primary my-1 " >Delete </button>
