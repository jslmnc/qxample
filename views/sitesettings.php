...
//select
  ...
  ?>
                center: new google.maps.LatLng(<?php echo (($result->coordinates));?>)<?php 
#$cnt = 0;
$cnt=$cnt+1; 
  }
  }
...
//select
  ...
  ?>
                position: new google.maps.LatLng(<?php echo (($result->coordinates));?>)
				<?php 
#$cnt = 0;
$cnt=$cnt+1; 
  }
...
?>,
            ...
            google.maps.event.addListener(vMarker, 'dragend', function (evt) {
				const latq=evt.latLng.lat().toFixed(6);
				const langq=evt.latLng.lng().toFixed(6);

				var loc=evt.latLng.lat().toFixed(6)+ ", "+evt.latLng.lng().toFixed(6);
               // $("#txtLat").val(evt.latLng.lat().toFixed(6));
                $("#txtLng").val(loc);
				//getReverseGeocodingData(latq, langq);
			//	$("#addressq").val(getReverseGeocodingData(latq, langq));
		//	$("#addressq").val(getAddress(latq,langq));

		fetch('https://nominatim.openstreetmap.org/reverse.php?lat='+latq +'&lon='+langq+'0&zoom=18&format=jsonv2')
    .then(res => res.json())
    .then((out) => {
		const idk = out;

		//alert(out.display_name);

		$("#addressq").val(out.display_name);
...
{
  $json = "https://nominatim.openstreetmap.org/reverse.php?lat=".$RG_Lat."&lon=".$RG_Lon."&zoom=18&format=jsonv2";
...
?>
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body onload="initialize();" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
		<!--begin::Main-->
		<!--begin::Root-->
  ...
  ?>
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Set the name of the group"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" name="id" hidden value="<?php echo htmlentities(($result->id))?>" />

																<input type="text" class="form-control form-control-solid" name="groupname" value="<?php echo htmlentities(($result->groupname))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Set the address."></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input class="form-control form-control-solid" data-bs-toggle="modal" data-bs-target="#kt_modal_map" id="address" name="address" value="<?php echo htmlentities(($result->address))?>"></input>
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																<!--begin::Label-->
																<label class="fs-6 fw-bold form-label mt-3">
																	<span class="required">Geocode</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the store geocode manually (coordinates)"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" id="coordinates" data-bs-toggle="modal" data-bs-target="#kt_modal_map" class="form-control form-control-solid" name="coordinates" value="<?php echo htmlentities(($result->coordinates))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															...
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="email" class="form-control form-control-solid" name="email" value="<?php echo htmlentities(($result->email))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															...
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="phone" value="<?php echo htmlentities(($result->contactno))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="SMTP Email Name"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="emailname" value="<?php echo htmlentities(($result->emailname))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="SMTP Email address"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="smtpemailaddress" value="<?php echo htmlentities(($result->smtpemailaddress))?>" />
																<!--end::Input-->
															</div>
														</div>
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="SMTP Host, example: smtp.gmail.com for gmail"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="host" value="<?php echo htmlentities(($result->host))?>" />
																<!--end::Input-->
															</div>
														</div>
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="SMTP Port"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="port" value="<?php echo htmlentities(($result->port))?>" />
																<!--end::Input-->
															</div>
														</div>
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="SMTP Email password"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="password" class="form-control form-control-solid" name="password" value="<?php echo htmlentities(($result->password))?>" />
																<!--end::Input-->
															</div>
														</div>
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Paypal Client ID"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="paypalclientid" value="<?php echo htmlentities(($result->paypalclientid))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
														...
														<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Paypal Secret Key"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="paypalsecretkey" value="<?php echo htmlentities(($result->paypalsecretkey))?>" />
																<!--end::Input-->
															</div>
														</div>
														<!--end::Input group-->
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							<h1 class="mb-3">Select Location</h1>
							...
							<div class="row mt-10">
								...
								<div class="col-lg-6 mb-10 mb-lg-0">
									...
									<div class="nav flex-column"  >
										...
										<!--end::Tab link--> <h2>
       Drag the Marker to get the Coordinates
    </h2>
  ...
  <br>
	...
	<div class="row fv-row mb-7">
															<div class="col-md-3 text-md-end">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	<span class="required">Address</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Addres (coordinates)"></i>
																</label>
																<!--end::Label-->
															</div>
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" disabled id="addressq" class="form-control form-control-solid" name="coordinates" value="<?php echo htmlentities(($result->address))?>" />
																<!--end::Input-->
															</div>
														</div>
	...
	<div class="row fv-row mb-7">
															...
															<div class="col-md-9">
																<!--begin::Input-->
																<input type="text" disabled id="txtLng" class="form-control form-control-solid" name="coordinates" value="<?php echo htmlentities(($result->coordinates))?>" />
																<!--end::Input-->
															</div>
														</div><?php 
#$cnt = 0;
...
?>
    ...
    <br />
						...
						<div class="d-flex flex-center flex-row-fluid pt-12">
							...
							<button type="submit" onclick=" copyText()" class="btn btn-primary">Select</button>
						</div>
						<!--end::Actions-->
					</div>
					<!--end::Modal body-->
                ...
                if (validator) {
                    validator.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
							...
							var form=$('#kt_ecommerce_settings_general_store')[0];
...
<script>
	function copyText(){
   document.getElementById("coordinates").value=document.getElementById("txtLng").value;
   document.getElementById("address").value=document.getElementById("addressq").value;

   $('#kt_modal_map').modal('hide');
}
