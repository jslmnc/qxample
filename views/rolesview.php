...
function getucount($dbh,$rolename){
...
if(!isset($_GET['rolename']) || $_GET['rolename'] == null){
										...
										<div class="card card-flush">
											...
											<div class="card-header">
												...
												<div class="card-title">
													<h2 class="mb-0"> Role: <?php echo ucfirst($_GET['rolename'])?></h2>
												</div>
												<!--end::Card title-->
											</div>
											<!--end::Card header-->
										...
										<div class="card card-flush mb-6 mb-xl-9">
											...
											<div class="card-header pt-5">
												...
												<div class="card-title">
													...
													<span class="text-gray-600 fs-6 ms-1"> (<?php echo getucount($dbh,$_GET['rolename'])?>)</span></h2>
												</div>
												...
												<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_roles_view_table">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th hidden class="text-end min-w-100px">Actions</th>
														</tr>
														<!--end::Table row-->
													</thead>
													<!--end::Table head-->
...
//$sql="SELECT * from books INNER JOIN authors ON books.authorid = authors.authorid INNER JOIN category ON category.categoryid = books.categoryid  ";
  ...
  $sql="SELECT * FROM user where role='".$_GET['rolename']."'";
  $query=$dbh->prepare($sql);
