			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
					...
					<div class="pt-lg-10 mb-10">
						...
						<!--end::Logo-->
						<!--begin::Message-->
						<div class="fs-3 fw-bold text-muted mb-10">The link you have clicked is invalid. Password reset link expired!
						<a href="#" class="link-primary fw-bolder"></a>
						<br />Please reset your password once again</div>
						<!--end::Message-->
						<!--begin::Action-->
						<div class="text-center mb-10" >
							<a type="submit" href="password-reset" class="btn btn-lg btn-primary fw-bolder">Reset Password</a>
						</div>
						<!--end::Action-->
						<!--begin::Action-->
						<div class="fs-5">
							<span class="fw-bold text-gray-700">You want to sign in instead?</span>
							<a href="sign-in" class="link-primary fw-bolder">Sign in</a>
						</div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
