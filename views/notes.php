							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">All Notes</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark"> Notes List</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="menu-sub menu-sub-accordion ">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
											...
											<span class="menu-link">
												...
												<a href="notes"><span class="menu-title">notebook1</span> </a>
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="users">
														...
														<span class="menu-title">note1</span>
													</a>
												</div>
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="users">
														...
														<span class="menu-title">+ Add new note</span>
													</a>
												</div>
										...
										<div class="menu-item">
											<a class="menu-link" href="myaccount">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">+ Add new notebook</span>
											</a>
										</div>
										...
										<div class="card card-flush" id="kt_contacts_list">
											...
											<div class="card-header pt-7" id="kt_contacts_list_header">
												...
												<form class="d-flex align-items-center position-relative w-100 m-0" autocomplete="off">
													...
													<!--end::Icon-->
													<!--begin::Input-->
													<input type="text" class="form-control form-control-solid ps-13" name="search" value="" placeholder="Search notes" />
													<!--end::Input-->
												</form>
												<!--end::Form-->
											</div>
												...
												<div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
													...
													<div class="d-flex flex-stack py-4">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-4">
																<a href="#" class="fs-6 fw-bolder text-gray-900 text-hover-primary mb-2">Note 1</a>
																<div class="fw-bold fs-7 text-muted">dasdandkls</div>
															</div>
															<button data-bs-toggle="modal1" data-bs-target="#kt_modal_invite_friends" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="right-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
																...
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="#" class="menu-link flex-stack px-3">Edit
																...
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div id="toggle"class="menu-item px-3 my-1">
																...
																<div class="menu-content px-3">
																				...
																				<label class="form-check form-switch form-check-custom form-check-solid">
																					<!--begin::Input-->
																					<input id ="clickb"class="form-check-input w-30px h-20px" type="checkbox" value="1" checked="checked" name="notifications">
																					<!--end::Input-->
																					<!--end::Label-->
																					<span id="changetext" class="form-check-label text-muted fs-6">Public</span>
																					<!--end::Label-->
																				</label>
																				<!--end::Switch-->
																			</div>
												...
												<form method ="post"id="kt_inbox_compose_form" >
													...
													<div class="d-block">
														...
														<div class="d-flex align-items-center border-bottom px-8 min-h-50px">
															...
															<div type="text" class="form-control form-control-transparent border-0" name="compose_to" value="" data-kt-inbox-form="ttagify" >	
														...
														<div class="border-bottom">
															<input class="form-control form-control-transparent border-0 px-8 min-h-45px" value="" class="title"name="title" placeholder="Title" />
														</div>
														<!--end::Subject-->
													...
													<div class="d-flex flex-stack flex-wrap gap-2 py-5 ps-8 pe-5 border-top">
														...
														<a class="me-2">
																<i  	data-bs-toggle="modal" data-bs-target="#voice_modal" class="fonticon-play text-primary fs-3"></i>
															</a> &nbsp;&nbsp;
													
																
														<label class="form-check-label" for="public_read"><span class="badge badge-light-primary">Views:  </span></label> &nbsp;  &nbsp; 
													...
													<button id="kt_referral_program_link_copy_btn" class="btn btn-light btn-active-light-primary fw-bolder flex-shrink-0" data-clipboard-target="#kt_referral_link_input">Copy Link</button>
															...
															<!--end::More actions-->
															<!--begin::Dismiss reply-->
															<span  class="btn btn-icon btn-sm btn-clean btn-active-light-primary" data-inbox="dismiss" data-toggle="tooltip" title="Delete">
...
" alt="image" class="w-100" />
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2"><?php echo $result->fname. ' '.$result->lname;?></a>
											<div class="fw-bold text-muted"><?php echo $result->email?></div>
										</div>
										<!--end::Details-->
									</div>
									<!--end::Details-->
