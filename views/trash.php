										...
										<div class="card card-flush mb-0" data-kt-sticky="true" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
											...
											<div class="card-body">
												...
												<div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
													...
													<div class="menu-item mb-3">
														<!--begin::Sent-->
														<a href="public" style="color: black"><span class="menu-link">
															<span class="menu-icon">
																<!--begin::Svg Icon | path: icons/duotune/general/gen016.svg-->
																<span class="svg-icon svg-icon-2 me-3">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													...
													<div class="menu-item">
														<!--begin::Trash-->
														<a href="trash"><span class="menu-link active">
															<span class="menu-icon">
										...
										<div class="card">
											<div class="card-header align-items-center py-5 gap-2 gap-md-5">
												...
												<div class="d-flex flex-wrap gap-1">
													...
													<!--end::Filter-->
													<!--begin::Reload-->
													<a href="#" id="cleartrash" class="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Clear Trash">
													...
													<!--end::Archive-->
													<!--begin::Delete-->
													<a href="#"id="all_delete" class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Untrash">
														<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
														<span class="svg-icon svg-icon-2">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																<path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="currentColor" />
												...
												<div class="d-flex align-items-center flex-wrap gap-2">
													...
													<div class="d-flex align-items-center position-relative">
														...
														<!--end::Svg Icon-->
														<input type="text" data-kt-inbox-listing-filter="search" class="form-control form-control-sm form-control-solid mw-100 min-w-150px min-w-md-200px ps-12" placeholder="Search trash" />
													</div>
													<!--end::Search-->
													<!--begin::Sort-->
													<span>
...
#$cnt = 0;
	...
	$trash=0;
	$sql="SELECT * FROM note where trash=1 AND userid=".$_SESSION['id']."";
...
$(document).ready(function(){
	$('#cleartrash').click(function(){
		var checkedValue = $('#ucheckbox:checked').val();
		if(checkedValue==1){
			//alert(' box is checked');

			Swal.fire({
                    text: "Are you sure you want to delete this trash?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    confirmButtonText: "Yes, untrash it!",
                    ...
                    if (result.value) {
						...
						$.ajax({
							...
							//	alert(response);
								...
								Swal.fire({
                            text: "Successfully deleted trash!",
                            icon: "success",
                            buttonsStyling: false,
...
$(document).ready(function(){
	$('#all_delete').click(function(){
		...
		if(checkedValue==1){
			...
			Swal.fire({
                    text: "Are you sure you want to untrash note?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    confirmButtonText: "Yes, untrash it!",
