						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">My Journal</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Journal</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">My Journal</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card">
									...
									<div class="card-header">
										<h2 class="card-title fw-bolder">Journal</h2>
										<div class="card-toolbar">
											...
											<!--end::Svg Icon-->Add Journal</button>
										</div>
									</div>
									<!--end::Card header-->
									<!--begin::Card body-->
											...
											<form class="form" action="#" id="kt_modal_add_event_form">
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="fv-row mb-9">
														<!--begin::Label-->
														<label class="fs-6 fw-bold required mb-2">Journal Name</label>
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" class="form-control form-control-solid" placeholder="" name="calendar_journal_name" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="fv-row mb-9">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" class="form-control form-control-solid" placeholder="" name="calendar_journal_description" />
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
...
$conn = new mysqli('localhost','root','','overflow');
if ($conn->connect_error) {
    die('Error : ('. $conn->connect_errno .') '. $conn->connect_error);
	
}
$query = $conn->query("SELECT * FROM note ORDER BY id");
?>
		<script>"use strict";
...
var KTAppCalendar = function () {
    ...
    var initCalendarApp = function () {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
			...
			//events: [< ?php while ($row = $query ->fetch_object()) { ?>{ id : '< ?php echo $row->id; ?>', title : '< ?php echo $row->notetitle; ?>', start : '< ?php echo $row->date; ?>', end : '< ?php echo $row->date; ?>', }, < ?php } ?>],
			...
			events: [<?php while ($row = $query ->fetch_object()) { ?>{ 
				...
				id: '<?php echo $row->id; ?>',
				title: '<?php echo $row->notetitle; ?>',
				start: '<?php echo $row->date; ?>',
				end:  '<?php echo $row->date; ?>',
				description: 'fc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warningfc-event-danger fc-event-solid-warning',
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Add a new Journal";
    ...
    return {
        ...
        init: function () {
            ...
            eventName = form.querySelector('[name="calendar_journal_name"]');
