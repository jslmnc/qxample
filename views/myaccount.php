...
?>
																...
																<div class="d-flex align-items-center">
																	...
																	function n($dbh,$planid){
																	 ...
																	 $sql="SELECT * FROM subscription where userid='".$_SESSION['userid']."'";
																				   ...
																				   ?>
																   <div class="fs-2 fw-bolder" ><?php echo sizeFormat(folderSize($folder_name));?></div>
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="myaccount">Overview</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
									...
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8">
												...
												<span class="fw-bolder fs-6 text-gray-800"><?php echo (ucfirst($result->fname))?></span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php echo (ucfirst($result->lname))?></span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php echo ($result->username)?></span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Row-->
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 text-gray-800 me-2"><?php echo ($result->email)?></span>
  ...
  ?>
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-header cursor-pointer">
										...
										<!--end::Card title-->
										<!--begin::Action-->
										<a href="billing" class="btn btn-primary align-self-center">Edit Subscription</a>
										<!--end::Action-->
									</div>
									<!--begin::Card header-->
									<!--begin::Card body-->
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Subscription ID</label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><span class="badge badge-success"><?php echo htmlentities($result->subscriberID)?></span></span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Plan ID</label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><span class="badge badge-success"><?php echo htmlentities($result->planID)?></span></span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Status		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Subscription Type"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8 d-flex align-items-center">
												
												<span class="badge badge-success"><?php echo htmlentities($result->status)?></span></span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Type		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Subscription Type"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8 d-flex align-items-center">
												
												<span class="badge badge-success"><?php if ($result->status=='ACTIVE'){echo 'PAID';}else{echo 'FREE';};?></span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Duration<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											
											<div class="col-lg-8 d-flex align-items-center">
												
												<span class="badge badge-success"><?php if ($result->status=='ACTIVE'){echo 'Until user cancels';}else{echo 'FREE';};?></span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Start Date<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											
											<div class="col-lg-8 d-flex align-items-center">
												
												<span class="badge badge-success"><?php echo htmlentities($result->startTime)?></span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">End Date<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											
											<div class="col-lg-8 d-flex align-items-center">
												
												<span class="badge badge-success"><?php if ($result->status=='ACTIVE'){echo 'Until the user cancels';}else{echo 'FREE';};?></span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Note Limit<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												...
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													...
													<span class="text-gray-800"><?php function casc1($dbh,$userid){
																...
																echo casc1($dbh,$_SESSION['id']);
														?>
														 of <?php function notesg($dbh,$planid){
														 			 	$sql="SELECT * FROM plans where planID='".$planid."'";
																		$query=$dbh->prepare($sql);
																		$query->execute();
																		$results=$query->fetchALL(PDO::FETCH_OBJ);
																		...
																		echo notesg($dbh,$result->planID).' ';
														?>Used</span>
												</div>
												<!--end::Heading-->
												<!--begin::Progress-->
												<div class="progress h-8px bg-light-primary mb-2">
													<div class="progress-bar bg-primary" role="progressbar" style="width: <?php if($result->status=="FREE"){echo (casc1($dbh,$_SESSION['id'])/100)*100*10;}else{echo (casc1($dbh,$_SESSION['id'])/100)*100;}?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10"><?php echo notesg($dbh,$result->planID)-casc1($dbh,$_SESSION['id']) ?> notes remaining until your plan requires update</div>
												<!--end::Description-->
												<!--begin::Action-->
										...
										<div class="row mb-7">
											...
											<label class="col-lg-4 fw-bold text-muted">
															Space Limit<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												...
												<!--begin::Heading-->
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													<span class="flex-grow-1 text-gray-800">Space</span>
													<span class="text-gray-800">
													<?php 	$folder_name='../files/user/'.$_SESSION['userid'];
												//$count_size=0;
														...
														<?php echo sizeFormat(folderSize($folder_name));?>
														out of 	<?php function spacel($dbh,$planid){
																		$sql="SELECT * FROM plans where planID='".$planid."'";
																		$query=$dbh->prepare($sql);
																		$query->execute();
																		$results=$query->fetchALL(PDO::FETCH_OBJ);
												...
												<!--begin:	<div class="progress-bar bg-primary" role="progressbar" style="width: < ?php  if($result->status=="FREE"){ $csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name)); echo sizeFormat2(floor(($sp/100)*100*10));}else{$csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name)); echo sizeFormat2(floor(($sp/100)*100));}?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
												Progress-->

												<div class="progress-bar bg-primary" role="progressbar" style="width: <?php  $csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name));  sizeFormat2(floor(($sp/100)*100)); if($result->status=="FREE"){ if(strpos(sizeFormat(folderSize($folder_name)), 'KB')!==false){echo '1';}}else{ if(strpos(sizeFormat(folderSize($folder_name)), 'KB')!==false){echo '1';} else{$csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name)); echo sizeFormat2(floor(($sp/100)*100));}}?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
												...
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10"><?php if($csp<$sp){echo '0';}else{$csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name));  echo sizeFormat($csp-$sp);} ?>  remaining until your plan requires update</div>
												<!--end::Description-->

												<!--begin:	<div class="fs-6 text-gray-600 fw-bold mb-10">< ?php  if(strpos(sizeFormat(folderSize($folder_name)),'KB')!==false){ echo 'yes';}else {
													echo ' no'; 
												} echo sizeFormat(folderSize($folder_name));?></div>::Action-->
												<!--begin::Action-->
