...
?>
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="billing">Billing</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
									...
									<div class="card-body">
										...
										<div class="row">
											...
											// echo 1;
														...
														return $r;
														  ...
														  if ($query->rowCount()>0) {
															...
															foreach ($results as $result) 
															{
															  ...
															  # code...?>
												<h3 class="mb-2">Subscription started: <?php $date=$result->startTime; echo htmlentities(date('F j, Y, g:i a',strtotime($date)))?></h3>
												<p class="fs-6 text-gray-600 fw-bold mb-6 mb-lg-15">You are subscribed to <?php echo plan($dbh,$result->planID)?></p>
												<!--end::Heading-->
												<!--begin::Info-->
												<div class="fs-5 mb-2">
													<span class="text-gray-800 fw-bolder me-1">$0</span>
													<span class="text-gray-600 fw-bold">Per Month</span>
												</div>
												<!--end::Info-->
												<!--begin::Notice-->
												<div class="fs-6 text-gray-600 fw-bold">With limited notes and storage</div><?php }else{?>
												...
												<!--begin::Info-->
												<div class="fs-5 mb-2">
													<span class="text-gray-800 fw-bolder me-1"><?php echo planprice($dbh,$result->planID)?></span>
													<span class="text-gray-600 fw-bold">Per Month</span>
												</div>
												<!--end::Info-->
												<!--begin::Notice-->
												<div class="fs-6 text-gray-600 fw-bold">With limited notes and storage</div>
...
?>Used</span>
												...
												<div class="progress-bar bg-primary" role="progressbar" style="width: <?php if($result->status=="FREE"){echo (casc($dbh,$_SESSION['id'])/100)*100*10;}else{echo (casc($dbh,$_SESSION['id'])/100)*100;}?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10"><?php echo notesg($dbh,$result->planID)-casc($dbh,$_SESSION['id']) ?> notes remaining until your plan requires update</div>
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													<span class="flex-grow-1 text-gray-800">Space</span>
													<span class="text-gray-800">	<?php 	$folder_name='../files/user/'.$_SESSION['userid'];
												//$count_size=0;
												...
												<!--begin::Progress-->
												<div class="progress h-8px bg-light-primary mb-2">
												<div class="progress-bar bg-primary" role="progressbar" style="width: <?php $csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name));  sizeFormat2(floor(($sp/100)*100)); if($result->status=="FREE"){ if(strpos(sizeFormat(folderSize($folder_name)), 'KB')!==false){echo '1';}}else{ if(strpos(sizeFormat(folderSize($folder_name)), 'KB')!==false){echo '1'; $csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name));  sizeFormat2(floor(($sp/100)*100));} else{$csp=spacel($dbh,$result->planID)*1048576; $sp=(folderSize($folder_name)); echo sizeFormat2(floor(($sp/100)*100));}}?>%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
												<!--begin::Description-->
												...
												<?php function subinfo($dbh,$userid){
												...
												function cancel($dbh,$userid){
													...
													// echo 1;
														...
														$can=cancel($dbh,$_SESSION['userid']);
													//	if($result->status!="FREE"){
														
															
												if(subinfo($dbh,$_SESSION['userid'])=="FREE"){
													...
													?>
													<a href="#" id="cancelsub" data-u-id="<?php echo cancel($dbh,$_SESSION['userid']); ?>" class="btn btn-light btn-active-light-primary me-2">Cancel Subscription</a>
											...
											<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
												...
												<div class="d-flex flex-column">
													...
													<div class="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
														...
														<button hidden class="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3" data-kt-plan="annual">Annual</button>
													</div>
													<!--end::Nav group-->
													<!--begin::Row-->
													<div class="row mt-10">
														...
														<?php $sql="SELECT * FROM plans WHERE cycle!='free'";
														  $query=$dbh->prepare($sql);
														  ...
														  if ($query->rowCount()>0) {
															...
															foreach ($results as $result) 
															{
																?>
																<!--begin::Tab link-->
																<div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6  mb-6 active" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
																	<!--end::Description-->
																	<div class="d-flex align-items-center me-2">
																		<!--begin::Radio-->
																		<div class="form-check form-check-custom form-check-solid form-check-success me-6">
																			<input class="form-check-input" type="radio" name="plan" checked="checked" value="<?php echo $result->plan_name?>" />
																		</div>
																		<!--end::Radio-->
																		<!--begin::Info-->
																		<div class="flex-grow-1">
																			<h2 class="d-flex align-items-center fs-2 fw-bolder flex-wrap"><?php echo $result->plan_name?></h2>
																			<div class="fw-bold opacity-50"><?php echo $result->plan_desc?></div>
																		</div>
																		<!--end::Info-->
																	</div>
																	<!--end::Description-->
																	...
																	<div class="ms-5">
																		...
																		<span class="fs-3x fw-bolder" data-kt-plan-price-month="<?php echo $result->price?>" data-kt-plan-price-annual="399"><?php echo $result->price?></span>
														...
														<div class="col-lg-6">
															...
															<div class="tab-content rounded h-100 bg-light p-10">
																...
																<div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
																	<!--begin::Heading-->
																	<div class="pb-5">
																		<h2 class="fw-bolder text-dark">What’s in <?php echo $result->plan_name?>?</h2>
																		<div class="text-muted fw-bold"><?php echo $result->plan_name?></div>
																	</div>
																	<!--end::Heading-->
																	<!--begin::Body-->
																	<div class="pt-1">
																		...
																		<div class="d-flex align-items-center mb-7">
																			<span class="fw-bold fs-5 text-gray-700 flex-grow-1">Up to <?php echo $result->note_limit?> Notes</span>
																		...
																		<!--begin::Item-->
																		<div class="d-flex align-items-center mb-7">
																			<span class="fw-bold fs-5 text-gray-700 flex-grow-1">Up to <?php echo $result->space_limit?>mb Storage</span>
																			<!--begin::Svg Icon | path: icons/duotune/general/gen043.svg-->
																			<span class="svg-icon svg-icon-1 svg-icon-success">
																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																					<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
...
<script> var token = "<?php echo getAuthToken($dbh);?>";
      ...
      paypal.Buttons({
        createSubscription: function(data, actions) {
          return actions.subscription.create({
            'plan_id': '<?php echo 'P-9WP83156CP272871TMLGHA3A';?>' // Creates the subscription
          });
        },
...
$(document).ready(function(){
	...
	Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        Swal.fire({
                            text: "Subscription was not Cancelled.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
