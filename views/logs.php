											...
											<table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
												...
												<thead class="border-gray-200 fs-5 fw-bold bg-lighten">
													...
													<tr>
														...
														<th class="min-w-150px">Time Spent</th>
														<th class="min-w-150px">Date</th>
													</tr>
												
												</thead>
												<?php
$sql="SELECT * FROM login_log  where userid =".$_SESSION['id']."";
$query=$dbh->prepare($sql);
...
?>			
												...
												<tbody class="fw-6 fw-bold text-gray-600">
													...
													<tr>
														...
														<td><?php echo htmlentities($result->device)?></td>
														...
														<td>
															...
															if($result->timeout==null){
																...
																$interval = $datetime1->diff($datetime2);
																echo '<span class="badge badge-light-warning fs-7 fw-bolder">'.$interval->format('%h')." Hour/s ".$interval->format('%i')." Minutes".'</span>';
															...
															<?php 
																		if($result->timeout==null){
																			echo 'from '.(date('F j, Y, g:i a',strtotime(($result->timein)))).' to <span class="badge badge-light-danger fs-7 fw-bolder">Not timed out yet</span>';

																			
																		}
																		else{
																			echo 'from '.(date('F j, Y, g:i a',strtotime(($result->timein)))).' to '.(date('F j, Y, g:i a',strtotime(($result->timeout))));
