...
?>
														...
														<div class="d-flex flex-wrap">
															...
															<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
																...
																<div class="d-flex align-items-center">
																	...
																	<!--end::Svg Icon-->
																	<div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="4" data-kt-countup-prefix="">0</div>
																</div>
																<!--end::Number-->
																<!--begin::Label-->
															...
															<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
																...
																<!--end::Number-->
																<!--begin::Label-->
																<div class="fw-bold fs-6 text-gray-400">Tags</div>
																<!--end::Label-->
															</div>
															<!--end::Stat-->
															<!--begin::Stat-->
															<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
																...
																<div class="d-flex align-items-center">
																	...
																	<!--end::Svg Icon-->
																	<div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="78" data-kt-countup-prefix="%">0</div>
																</div>
																<!--end::Number-->
																<!--begin::Label-->
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
											...
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="myfiles">My Files</a>
											</li>
											<!--end::Nav item-->
										</ul>
										<!--begin::Navs-->
  ...
  ?>
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800">SUBID-1</span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Plan Name</label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800">Plan 1</span>
											</div>
											<!--end::Col-->
										</div>
										<div class="row mb-7">
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Balance<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 d-flex align-items-center">
												...
												<span class="badge badge-success">06/08/2022 06:36:59 pm</span>
											</div>
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Tags Limit		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Tag limit"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800"><?php //echo ($result->username)?></span>
												...
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													<span class="flex-grow-1 text-gray-800">Tags</span>
													<span class="text-gray-800">3 of 100 Used</span>
												</div>
												<!--end::Heading-->
												<!--begin::Progress-->
												...
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10">97 tags remaining until your plan requires update</div>
												<!--end::Description-->
												<!--begin::Action-->
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8">
												...
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													...
													<span class="text-gray-800">4 of 100 Used</span>
												</div>
												<!--end::Heading-->
												<!--begin::Progress-->
												<div class="progress h-8px bg-light-primary mb-2">
													<div class="progress-bar bg-primary" role="progressbar" style="width: 4%" aria-valuenow="4" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10">96 notes remaining until your plan requires update</div>
												<!--end::Description-->
												<!--begin::Action-->
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Space Limit<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
												...
												<div class="d-flex text-muted fw-bolder fs-5 mb-3">
													...
													<span class="text-gray-800">7mb out of 100mb Used</span>
												</div>
												<!--end::Heading-->
												<!--begin::Progress-->
												<div class="progress h-8px bg-light-primary mb-2">
												...
												<!--end::Progress-->
												<!--begin::Description-->
												<div class="fs-6 text-gray-600 fw-bold mb-10">93mb remaining until your plan requires update</div>
												<!--end::Description-->
												<!--begin::Action-->
										...
										<div class="row mb-7">
											<!--begin::Label-->
											<label class="col-lg-4 fw-bold text-muted">Share Limit<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email must be active"></i></label>
											<!--end::Label-->
											<!--begin::Col-->
											<div class="col-lg-8">
