									...
									<div class="menu-sub menu-sub-accordion ">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
											...
											<span class="menu-link">
												...
												<span class="menu-title">notebook1</span> 	<li class="nav-item dropdown">
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="users">
														...
														<span class="menu-title">NOTEBOOKSHARED</span>
													</a>
												</div>
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link" href="plans">
												...
												<span class="menu-title">Tag 1</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="subscription">
												...
												<span class="menu-title">Tag 2</span>
											</a>
										</div>
												...
												<div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_contacts_list_header" data-kt-scroll-wrappers="#kt_content, #kt_contacts_list_body" data-kt-scroll-stretch="#kt_contacts_list, #kt_contacts_main" data-kt-scroll-offset="5px">
													...
													<div class="d-flex flex-stack py-4">
														...
														<div class="d-flex align-items-center">
															...
															<!--begin::Details-->
															<div class="ms-4">
																<a href="../../Overflow/views/apps/contacts/view-contact.html" class="fs-6 fw-bolder text-gray-900 text-hover-primary mb-2">Note 1</a>
