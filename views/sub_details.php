...
function sendemailsub($dbh,$getname, $email,$panname,$planammount){



  $p=planp($dbh,subid($dbh,$_SESSION["userid"])); 
  //echo number_format($p,2);


  $date1 = sst1($dbh,$_SESSION["userid"]);
$date1 = date("Y-m-d", strtotime("last day of next month",strtotime($date1)));
  ...
  if ($query->rowCount()>0) {
	...
	//	$mail->Password   = 'OverflowgroupQ!1';                               //SMTP password
	   ...
	   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
		...
		$mail->Subject = 'You sent an automatic payment to Overflow, For '.$panname.' $'.number_format($planammount,2);'';
...
<title></title><!-- Noto Sans Google Font --><link href="https://fonts.googleapis.com/css?family=Noto+Sans:400,400italic,700,700italic&amp;subset=latin,greek,greek-ext,devanagari,vietnamese,cyrillic-ext,latin-ext,cyrillic" rel="stylesheet" type="text/css">
<style type="text/css">
<!-- Begin Styles -->
/* PP Sans Font Import */
@font-face {
...
<td align="center" width="600"><table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f5f5">
 <tbody><tr> 
   <!-- copy 14px/18px -->
   <td align="center" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:14px; line-height:18px;color:#777777;padding:20px" class="ppsans">Hello, '.name($dbh,$_SESSION["userid"]) .'</td>
   <!-- end copy --> 
 </tr>
</tbody></table>
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tbody><tr> 
               <!-- sub header 19/24 -->
                  ...
                  '.planname($dbh,subid($dbh,$_SESSION["userid"])).'.</td>
               <!-- end primary headline --> 
             </tr>
           </tbody></table></td>
       </tr>
...
<table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
             <tbody><tr> 
               <!-- details copy 13/22 -->
               <td valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:13px; line-height:18px; color:#777777;" class="ppsans ">Subscription ID:&nbsp;'.sid($dbh,$_SESSION["userid"]).'</td>
               <!-- end details copy --> 
                   <!-- details copy 13/22 -->
               <td width="30%" align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:13px; line-height:18px; color:#777777; padding-left:10px" class="ppsans padding0">'. sst($dbh,$_SESSION["userid"]).'</td>
               <!-- end details copy --> 
...
<table align="left" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
         ...
         <td valign="top" width="30%" align="right">
           <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
             <tbody><tr> 
               <!-- money total 20/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:20px; line-height:22px; color:#333333;" class="ppsans"><!--  topPadding10 -->$'.number_format($p,2).'&nbsp;USD</td>
               <!-- end money total --> 
             </tr>
           </tbody></table>
        </td>
...
<td bgcolor="#f5f5f5" align="center" style="padding:10px 0px 10px 0px;">
           <table cellpadding="0" cellspacing="0" border="0" width="100%">
             ...
             <tbody><tr> 
               ...
               <!-- end money total --> 
               <!-- money total 22/24 -->
               <td width="40%" align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:24px; color:#333333; padding-left:30px; padding-bottom:10px;" class="ppsans autoWidth"><span style="font-weight:bold"><div id="aee646ec-2801-75c2-5e13-5d1881780aff">$'.number_format($p,2).'&nbsp;USD</div></span></td>
               <!-- end money total --> 
             </tr>
...
<td bgcolor="#f5f5f5" align="center" style="padding:10px 0px 10px 0px;">
           <table cellpadding="0" cellspacing="0" border="0" width="100%">
             ...
             <tbody><tr> 
               ...
               <!-- end money total --> 
               <!-- money total 22/24 -->
               <td width="40%" align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:24px; color:#333333; padding-left:30px; padding-bottom:10px;" class="ppsans autoWidth"><span style="font-weight:bold">$'.number_format($p,2).'&nbsp;USD</span></td>
               <!-- end money total --> 
             </tr>
             <!-- end money total / row 1 --> 
           </tbody></table>
...
<td valign="top" class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:17px; line-height:22px; color:#444444;">Next payment amount:</td>
               <!-- end details copy --> 
               <!-- details copy 13/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:22px; color:#333333; padding-left:10px;" class="ppsans">$'.number_format($p,2).'&nbsp;USD</td>
               <!-- end details copy --> 
             </tr>
           </tbody></table>
<!-- <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
...
<td valign="top" class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:17px; line-height:22px; color:#444444;">Subscription ID:</td>
               <!-- end details copy --> 
               <!-- details copy 13/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:22px; color:#333333; padding-left:10px;" class="ppsans">'.sid($dbh,$_SESSION["userid"]).'</td>
               <!-- end details copy --> 
             </tr>
           </tbody></table>
<!-- <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
...
<td valign="top" class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:17px; line-height:22px; color:#444444;">Payments from:</td>
               <!-- end details copy --> 
               <!-- details copy 13/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:22px; color:#333333; padding-left:10px;" class="ppsans">&nbsp;'.name($dbh,$_SESSION["userid"]).'<br>&nbsp;'.email($dbh,$_SESSION["userid"]).'</td>
               <!-- end details copy --> 
             </tr>
           </tbody></table>
<!-- <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
...
<td valign="top" class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:17px; line-height:22px; color:#444444;">Payments for:</td>
               <!-- end details copy --> 
               <!-- details copy 13/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:22px; color:#333333; padding-left:10px;" class="ppsans">&nbsp;'. planname($dbh,subid($dbh,$_SESSION["userid"])).'</td>
               <!-- end details copy --> 
             </tr>
           </tbody></table>
<!-- <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
...
<td valign="top" class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:17px; line-height:22px; color:#444444;">Payments start:</td>
               <!-- end details copy --> 
               <!-- details copy 13/22 -->
               <td align="right" valign="top" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:22px; line-height:22px; color:#333333; padding-left:10px;" class="ppsans">'.sst($dbh,$_SESSION["userid"]).'</td>
               <!-- end details copy --> 
             </tr>
           </tbody></table>
<!-- <table align="right" cellpadding="0" cellspacing="0" border="0" class="stackTbl">
...
curl_setopt($ch,CURLOPT_URL,'https://api-m.sandbox.paypal.com/v1/billing/subscriptions/'.rawurldecode($subscriptionID));
curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);
...
//var_dump($response);
 ...
 $start_time=$response['start_time'];
    $status_update_time=$response['status_update_time'];
     ...
     //$payer_email=$response["subscriber"]['email_address'];
   // $payer_id=$response["subscriber"]['payer_id'];
    //$payer_name=$response['given_name'].' '.$response['surname'];

    $payer_email=email($dbh,$_SESSION['userid']);
    $payer_name=name($dbh,$_SESSION['userid']);
...
$uid=1;
    ...
    if($status=='ACTIVE' && $subscriberID==$subscriptionID){
     //   $sql="UPDATE subscription set status=:status,subscriberID=:subscriberID,planID=:planID,startTime=:startTime,status_update_time=:status_update_time,currency_code=:currency_code,payer_email=:payer_email, payer_id=:payer_id, payer_name=:payer_name where userid=:userid";
      //  $query=$dbh->prepare($sql);
     //   $query->bindParam(':status',$status,PDO::PARAM_STR);
     //   $query->bindParam(':subscriberID',$subscriberID,PDO::PARAM_STR);
     //   $query->bindParam(':planID',$planID,PDO::PARAM_STR);
     //   $query->bindParam(':startTime',$start_time,PDO::PARAM_STR);
      //  $query->bindParam(':status_update_time',$status_update_time,PDO::PARAM_STR);
      //  $query->bindParam(':currency_code',$currency_code,PDO::PARAM_STR);
      //  $query->bindParam(':payer_email',$payer_email,PDO::PARAM_STR);
      //  $query->bindParam(':payer_id',$payer_id,PDO::PARAM_STR);
      //  $query->bindParam(':payer_name',$payer_name,PDO::PARAM_STR);
      ...
      // $sql="INSERT INTO subscription(userid,status,subscriberID,planID,startTime,status_update_time,payer_email,payer_id,cycles)
     //  VALUES(:userid,:status,:subscriberID,:planID,:startTime,:status_update_time,:payer_email,:payer_id,:cycles)";
     //  $query=$dbh->prepare($sql);
     ...
     //  $query->bindParam(':payer_email',$payer_email,PDO::PARAM_STR);
    //   $query->bindParam(':payer_id',$payer_id,PDO::PARAM_STR);
     //  $query->bindParam(':cycles',$cycles,PDO::PARAM_STR);
      
       $cycles=1;
       
       

       $sql="UPDATE subscription set status=:status,subscriberID=:subscriberID,planID=:planID,startTime=:startTime,status_update_time=:status_update_time,payer_email=:payer_email,cycles=:cycles where userid=:userid";
       $query=$dbh->prepare($sql);
       $query->bindParam(':status',$status,PDO::PARAM_STR);
       $query->bindParam(':subscriberID',$subscriberID,PDO::PARAM_STR);
       $query->bindParam(':planID',$planID,PDO::PARAM_STR);
      ...
      // $query->execute();
      sendemailsub($dbh,$payer_name, $payer_email,planname($dbh,$planID),planp($dbh,$planID));
      // $query->bindParam(':cycles',$cycles,PDO::PARAM_STR);

         $query->execute();

      # INSERT INTO `subscription`(`id`, `userid`, `status`, `subscriberID`, `planID`, `startTime`, `status_update_time`, `payer_email`, `payer_id`, `cycles`, `date`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]','[value-11]')
     
      header('Location: success.php?status='.$status.'&uid='.encry($_SESSION['userid']));
        // "UPDATE `subscription` SET `userid`=[value-2],`status`=[value-3],`subscriberID`=[value-4],`planID`=[value-5],`startTime`=[value-6],`status_update_time`=[value-7],`currency_code`=[value-8],`payer_email`=[value-9],`payer_id`=[value-10],`payer_name`=[value-11],`date`=[value-12] WHERE 1";
    }
    else{
     // header('Location: views/success.php?status='.'FAILED');

      //  header('Location: views/success.php?status='.$status);
