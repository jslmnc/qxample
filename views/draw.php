						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Draw</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Draw</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Draw</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
...
<!--begin::Post-->
		...
		<div id="toolbar">
			...
			<div id="clearCanvas" class="drawTool">
				Clear
			</div>
			...
			<a href="save" id="save" class="drawTool">
				Save
			</a>
			<div id="eraser" class="drawTool">
				<i class="fas fa-eraser"></i>
			</div>
			<div id="filldrip" class="drawTool">
				<i class="fa fa-fill-drip"></i>
			</div>
			<div id="brush" class="drawTool">
