																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<div class="image-input image-input-outline" data-kt-image-input="true" >
																			<!--begin::Preview existing avatar-->
																			<div class="image-input-wrapper w-125px h-125px" style="background-image: url('../default.jpg');"></div>
																			<!--end::Preview existing avatar-->
																			<!--begin::Label-->
																			<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
																				<i class="bi bi-pencil-fill fs-7"></i>
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="fname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="First name"  />
																		<!--end::Input-->
																	</div>
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="lname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Last name" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="password" name="cpassword" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="********"  />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="mb-7">
																		...
																		<div class="d-flex fv-row">
																			...
																			<div class="form-check form-check-custom form-check-solid">
																				<!--begin::Input-->
																				<input class="form-check-input me-3" name="role" type="radio" value="user" id="kt_modal_update_role_option_0" checked='checked' />
																				<!--end::Input-->
																				<!--begin::Label-->
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../Overflow/views/apps/user-management/users/view.html">
...
" alt="image" class="w-100" />
													...
													<!--	copy("../default.jpg", "../files/user/".$username."/profile/default.jpg"); -->
														...
														<div class="d-flex flex-column">
															<a href="viewuser?id=<?php echo $result->uid?>" class="text-gray-800 text-hover-primary mb-1"><?php echo htmlentities(ucfirst($result->fname))." ".(ucfirst($result->lname))?></a>
													...
													<!--end::Two step=-->
													<!--begin::Joined-->
													<td><?php $date=$result->date_create; echo htmlentities(date('F j, Y, g:i a',strtotime($date)))?></td>
													
													<?php if(($result->status)=='online'){
														
														
														
														?>
													<td>	<div class="badge badge-light-success fs-7 fw-bolder"><?php echo htmlentities(ucfirst($result->status))?></div></td>
													<?php }

													else{
														?>
													<td>	<div class="badge badge-light-danger fs-7 fw-bolder"><?php echo htmlentities(ucfirst($result->status))?></div></td>
														...
														?>
															<?php if(($result->type)=='active'){
														
														
														
														?>
													<td>	<div class="badge badge-light-success fs-7 fw-bolder"><?php echo htmlentities(ucfirst($result->type))?></div></td>
													<?php }

													else if(($result->type)=='banned'){
														?>
													<td>	<div class="badge badge-light-danger fs-7 fw-bolder"><?php echo htmlentities(ucfirst($result->type))?></div></td>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="viewuser?id=<?php echo $result->uid;?>" class="menu-link px-3">View</a>
															</div>
															...
															<div class="menu-item px-3">
																...
																<a href="#" onclick="deleteuser(<?php echo htmlentities($result->id);?>)" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete </a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
