...
//count 
function getucount($dbh,$plan){

	

	$sql1 ="SELECT count(*) as total from subscription where planID='".$plan."'";
...
if(!isset($_GET['planID']) || $_GET['planID'] == null){
	echo "<script>window.location='roles';</script>";
	 ...
	 $planID   = $_GET['planID'];
		...
		if($query->rowCount()>0)
		{
			...
			echo "<script>window.location='plans';</script>";
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Plan List</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">View Plan</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
										...
										<div class="card card-flush">
											...
											<div class="card-header">
												...
												<div class="card-title">
													...
													<h2 class="mb-0"> Plan Name: <br><?php

													function planname($planid,$dbh){
													...
													echo planname(($_GET['planID']),$dbh)?></h2>
											...
											<div class="card-footer pt-0">
												<button hidden type="button" class="btn btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">Edit Role</button>
											</div>
											<!--end::Card footer-->
										</div>
										<!--end::Card-->
									...
									<div class="flex-lg-row-fluid ms-lg-10">
										...
										<div class="card card-flush mb-6 mb-xl-9">
											...
											<div class="card-header pt-5">
												...
												<div class="card-title">
													<h2 class="d-flex align-items-center">Users Subscribed to <?php echo planname(($_GET['planID']),$dbh) ?>
													<span class="text-gray-600 fs-6 ms-1"> (<?php echo getucount($dbh,$_GET['planID'])?>)</span></h2>
												</div>
...
//$sql="SELECT * from books INNER JOIN authors ON books.authorid = authors.authorid INNER JOIN category ON category.categoryid = books.categoryid  ";
 ...
 // $sql="SELECT * FROM user where planID='".$_GET['planID']."'";
  $sql="SELECT * from user INNER JOIN subscription ON user.uid = subscription.userid where planID='".$_GET['planID']."' ";
  $query=$dbh->prepare($sql);
														...
														<tr>
															...
															<td class="d-flex align-items-center">
																...
																<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																	<a href="viewuser?id=<?php echo ($result->uid)?>">
...
" alt="image" class="w-100" />																		</div>
																...
																<div class="d-flex flex-column">
																	<a href="viewuser?id=<?php echo ($result->uid)?>" class="text-gray-800 text-hover-primary mb-1"><?php echo ($result->fname." ".$result->lname)?></a>
