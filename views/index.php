					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							...
							<span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">Overflow</span>
							</span></h1>
							<!--end::Title-->
							<!--begin::Action-->
							<a href="../../Overflow/views/index.html" class="btn btn-primary">Try Overflow</a>
							<!--end::Action-->
						</div>
						<!--end::Heading-->
						<!--begin::Clients-->
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bolder text-dark">Create Account</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bolder text-dark">Setup Your Notes</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
						...
						<div class="col-md-4 px-5">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bolder text-dark">Enjoy Overflow App</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="fs-2 fw-bold text-muted text-center">
							<a href="../../Overflow/views/account/security.html" class="link-primary fs-4 fw-bolder">Marcus Levy,</a>
					...
					<div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
						...
						<div class="card-body p-lg-20">
							...
							<div class="text-center mb-5 mb-lg-10">
								<!--begin::Title-->
								<h3 class="fs-2hx text-dark mb-5" id="portfolio" data-kt-scroll-offset="{default: 100, lg: 150}">Our Explainer Video</h3>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Tabs wrapper-->
			...
			<div class="mt-20 mb-n20 position-relative z-index-2">
				...
				<div class="container">
					...
					<div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13" style="background: linear-gradient(90deg, #20AA3E 0%, #03A588 100%);">
						...
						<!--end::Content-->
						<!--begin::Link-->
						<a href="contactus" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Contact Us</a>
						<!--end::Link-->
					</div>
					<!--end::Highlight-->
				</div>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9">
									...
									<a href="../../Overflow/views/pages/user-profile/overview.html" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
							</div>
							...
							<div class="col-lg-6 ps-lg-16">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="d-flex fw-bold flex-column me-20">
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../Overflow/views/documentation/getting-started.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Documentaions</a>
										<!--end::Link-->
										<!--begin::Link-->
										...
										<!--end::Link-->
										<!--begin::Link-->
										<a href="../../Overflow/views/documentation/getting-started/changelog.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Changelog</a>
										<!--end::Link-->
										<!--begin::Link-->
					...
					<div class="container">
						...
						<div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
							...
							<div class="d-flex align-items-center order-2 order-md-1">
								<!--begin::Logo-->
								<a href="../../Overflow/views/landing.html">
									<img alt="Logo" src="assets/media/logos/overflowlogo.png" class="h-15px h-md-20px" />
								</a>
								<!--end::Logo image-->
								<!--begin::Logo image-->
								<span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="https://keenthemes.com">© 2022 Overflow Group.</span>
								<!--end::Logo image-->
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
								<li class="menu-item">
									<a href="aboutus" target="_blank" class="menu-link px-2">About</a>
								</li>
								<li class="menu-item mx-5">
									<a href="ourteam" target="_blank" class="menu-link px-2">Team</a>
								</li>
								<li class="menu-item">
									<a href="contactus" target="_blank" class="menu-link px-2">Contact</a>
								</li>
							</ul>
							<!--end::Menu-->
						</div>
