...
function getcurrentime($uid,$dbh){


	$sql="SELECT * FROM chat WHERE incomingid=:incomingid ";
	$query=$dbh->prepare($sql);
	$query->bindParam(':incomingid',$uid,PDO::PARAM_STR);
	$query->execute();
	$results=$query->fetch(PDO::FETCH_ASSOC);
	if($query->rowCount()>0)
	{
		$r=$results['currenttime'];
		echo $r;
...
Dribbble: www.dribbble.com/keenthemesSear
...
?>
														...
														<div class="d-flex flex-column align-items-end ms-2">
															<span class="text-muted fs-8 mb-1"><?php 
														
														//	echo  getcurrentime($result->uid,$dbh);
															?></span>
														</div>
									...
									<div class="card card-flush h-lg-100" id="kt_contacts_main">
											...
											<div class="card-body p-0">
												...
												<div class="card-px text-center py-20 my-10">
													<!--begin::Title-->
													<h2 class="fs-2x fw-bolder mb-10">Welcome to the Chat App</h2>
													<!--end::Title-->
													<!--begin::Description-->
													<p class="text-gray-400 fs-4 fw-bold mb-10">It's time to expand our contacts.
													<br />Click or search for people to start chatting.</p>
													<!--end::Description-->
													<!--begin::Action-->
