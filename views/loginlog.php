...
function getname($id,$dbh){
	...
	$fname=$results['fname']." " .$results['lname'];
	return $fname;
	}
	else{

		echo "User no longer existed.";
	  }
	//  if()
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Login Log</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Login Logs</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Time out</th>
...
//$sql="SELECT * from books INNER JOIN authors ON books.authorid = authors.authorid INNER JOIN category ON category.categoryid = books.categoryid  ";
  ...
  ?>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check form-check-sm form-check-custom form-check-solid">
															<input class="form-check-input" id ="ucheckbox"type="checkbox" data-i-id="<?php echo $result->id ?>" value=<?php echo htmlentities($result->id)?> />	
														</div>
													</td>
													...
													<!--end::User=-->
													<!--begin::Role=-->
													<td class="text-gray-800 text-hover-primary mb-1" > <?php echo "ID-".($result->userid)?>

													<td class="text-gray-800 text-hover-primary mb-1" > <?php echo getname($result->userid,$dbh)?>
								...
								<!--begin:: Avatar -->
													...
													<!--begin::Last login=-->
													<td>
													<?php echo htmlentities($result->device)?>
													</td>
													<!--end::Last login=-->
													<!--begin::Two step=-->
													<!--end::Two step=-->
													...
													<td><?php $date=$result->timein; echo htmlentities(date('F j, Y, g:i a',strtotime($date)))?></td>
													
													
													
													<td><?php if($result->timeout==null){
														echo '<span class="badge badge-light-success fs-7 fw-bolder">Now</span>';}
														else{$date=$result->timeout; echo htmlentities(date('F j, Y, g:i a',strtotime($date)));}?></td>
...
var KTUsersList = function () {
	...
	var exportButtons = () => {
        ...
        const documentTitle = 'Login Log Report as of '+s;
