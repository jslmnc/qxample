...
if(!isset($_GET['receiver']) || $_GET['receiver'] == null){
  ...
  $outgoingid   = $_GET['receiver'];

	
  $sql="SELECT * FROM user WHERE uid=:uid ";
  $query=$dbh->prepare($sql);
  $query->bindParam(':uid',$outgoingid,PDO::PARAM_STR);
  $query->execute();
										...
										<div class="card card-flush">
											...
											<div class="card-header pt-7" id="kt_chat_contacts_header">
												...
												<form class="w-100 position-relative" autocomplete="off">
													...
													<!--end::Icon-->
													<!--begin::Input-->
													<input type="text" class="form-control form-control-solid px-15" name="search_text" id="search_text" value="" placeholder="Search by username or email..." />
													<!--end::Input-->
												</form>
												<!--end::Form-->
											</div>
...
?>
															...
															<!--begin::Details-->
															<div class="ms-5">
																<a href="chats?sender=<?php echo $_SESSION['userid']?>&receiver=<?php echo $result->uid?>" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2"><?php echo htmlentities(ucfirst($result->fname).' '.(ucfirst($result->lname)))?></a>
																<div class="fw-bold text-muted"><?php echo htmlentities(($result->email))?></div>
															</div>
															<!--end::Details-->
														</div>
														<!--end::Details-->
														...
														<div class="d-flex flex-column align-items-end ms-2">
															<span class="text-muted fs-8 mb-1">.</span>
														</div>
											...
											<div class="card-header" id="kt_chat_messenger_header">
												...
												<div class="card-title">
													...
													<div class="d-flex justify-content-center flex-column me-3">
														<a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1"><?php echo htmlentities(ucfirst($result->fname)).' '.(ucfirst($result->lname))?></a>
														<!--begin::Info-->
														<div class="mb-0 lh-1">
															...
															if($result->status=="online"){
																...
																?>
																<span class="fs-7 fw-bold text-muted">Offline</span>
<?php
															}
															?>
...
?>
											...
											<div class="card-footer pt-4" id="kt_chat_messenger_footer">
												...
												<textarea id="message" name="message" style="resize:none;"class="form-control form-control-flush mb-3" rows="1" data-kt-element="input" placeholder="Type a message"></textarea>
												<!--end::Input-->
												<!--begin:Toolbar-->
												<div class="d-flex flex-stack">
													...
													<!--end::Actions-->
													<!--begin::Send-->
													<button  onclick ="return chat_validation()" id="btm" data-kt-element="send" class="btn btn-primary" type="button" >Send</button>
...
<script type="text/javascript">
		document.querySelector("#btm").addEventListener("click",()=>{
			...
			//window.scrollTo.scrollTop = messages.scrollHeight;
