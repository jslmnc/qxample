														...
														<div class="row mb-6">
															<div class="col-lg-6 mb-4 mb-lg-0">
																<div class="fv-row mb-0">
																	<label for="emailaddress" class="form-label fs-6 fw-bolder mb-3">Enter New Email Address</label>
																		...
																		<input type="email"  required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" oninput="checkEmail()" class="form-control form-control-lg form-control-solid" id="updatee" placeholder="Email Address" name="updatee" value=<?php echo ($result->email)?> />
																
																	<div id="update-email" ></div>
																	<div class="fv-plugins-message-container invalid-feedback" id="emailValidation"></div>
																</div>
															...
															<div class="col-lg-6">
																<div class="fv-row mb-0">
																	...
																	<input type="password" oninput="checkCurrentPassword2()" class="form-control form-control-lg form-control-solid" name="passe" id="passe" />
																	<div id="check-passe" ></div>
																</div>
															</div>
														</div>
														<div class="d-flex">
															<button type="submit" name="updateemail"class="btn btn-primary me-2 px-6">Update Email</button>
...
?>
												...
												<div id="kt_signin_password_edit" class="flex-row-fluid d-none">
													...
													<form method="post" class="form" >
														<div class="row mb-1">
															<div class="col-lg-4">
																<div class="fv-row mb-0">
																	...
																	<input  type="password" oninput="checkCurrentPassword()" class="form-control form-control-lg form-control-solid" name="currentpassword" id="currentpassword" />
																	
																	<div id="check-current-password" ></div>
															...
															<div class="col-lg-4">
																<div class="fv-row mb-0">
																	...
																	<input oninput="checkPassword(),CheckPasswordMatch()" type="password" class="form-control form-control-lg form-control-solid" name="password" id="password" />
															...
															<div class="col-lg-4">
																<div class="fv-row mb-0">
																	...
																	<input oninput="checkPassword(),CheckPasswordMatch()" type="password" class="form-control form-control-lg form-control-solid" name="cpassword" id="cpassword" />
																	<div id="check-password" ></div>

																	<div class="fv-plugins-message-container invalid-feedback" id="CheckPasswordMatch"></div>
														...
														<div class="d-flex">
															<button type="submit" name="updatepass" class="btn btn-primary me-2 px-6">Update Password</button>
...
unset($_SESSION['status']);
	...
	//	let username = document.getElementById('username');
        var email = $("#updatee").val();
       

		var regex2 = /[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/;
	...
	if(email.match(regex2))
		{
			...
			$("#emailValidation").html("The value is not a valid email address");
...
<script>
			function checkCurrentPassword() {
					...
					type: "POST",
					success:function(data){
					$("#check-current-password").html(data);
...
<script>
			function checkEmail() {
					...
					jQuery.ajax({
					url: "check.php",
					data:'updatee='+$("#updatee").val(),
					type: "POST",
					success:function(data){
					$("#update-email").html(data);
...
<script>
			function checkCurrentPassword2() {
				
					jQuery.ajax({
					url: "check.php",
					data:'passe='+$("#passe").val(),
					type: "POST",
					success:function(data){
					$("#check-passe").html(data);
	...
	if(username.match(regex2))
		{
			...
			$("#usernameValidation").html("Only Alphabets, Numbers and Underscore and between 3 to 20 characters!");
...
<script>
	...
	//	let username = document.getElementById('username');
		...
		var regex1 = /^(?=.{2,20}$)[a-z]+(?:['_.\s][a-z]+)*$/i;
	  

	if(fname.match(regex1))
		{
			$("#nameValidation1").html("");
			//document.getElementById("submit").disabled = false;

		}
		else{
			$("#nameValidation1").html("First name must be atleast 2-20 letters");
		...
		if(fname=="")
		{
			$("#nameValidation1").html("First name is required!");
		}



		if(lname.match(regex1))
		{
			$("#nameValidation2").html("");
		}
		else{
			$("#nameValidation2").html("Last name must be atleast 2-20 letters");
		...
		if(lname=="")
		{
			$("#nameValidation2").html("Last name is required!");
		}

	  
    }
    $(document).ready(function () {
       $("#fname").keyup(nameValidation1);
	   $("#lname").keyup(nameValidation2);
