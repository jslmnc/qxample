													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<div class="mb-10">
															...
															<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
																...
																<option value="offline">CANCELLED</option>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-100px">UserID</th>
													<th class="min-w-100px">Status</th>
													<th class="min-w-100px">SubscriberID</th>
													<th class="min-w-100px">Plan ID</th>
													<th class="min-w-100px">Start Time</th>
													<th class="min-w-100px">Payer Email</th>
													<th class="min-w-100px">Payer ID</th>
													<th class="min-w-100px">Cycles</th>
...
//$sql="SELECT * from books INNER JOIN authors ON books.authorid = authors.authorid INNER JOIN category ON category.categoryid = books.categoryid  ";
  ...
  ?>
												...
												<tr>
													...
													<!--begin::Joined-->
													<td>
													<?php echo htmlentities($result->subscriberID)?>
													</td>
													<td>
													<?php echo htmlentities($result->planID)?>
													</td>
													<td>
													<td>
													<?php echo htmlentities($result->startTime)?>
													</td>
													<td>
													<?php echo htmlentities($result->payer_email)?>
													</td>
													<td>
													<?php echo htmlentities($result->cycles)?>
													</td>
