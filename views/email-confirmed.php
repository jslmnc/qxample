			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
					...
					<div class="pt-lg-10 mb-10">
						...
						<!--begin::Logo-->
						<h1 class="fw-bolder fs-2qx text-gray-800 mb-7">Email confirmed!</h1>
						<!--end::Logo-->
						<!--begin::Message-->
						<div class="fw-bold fs-3 text-muted mb-15">You successfully confirmed your email. Please Sign
						<br />in to your account to get started.</div>
						<!--end::Message-->
						<!--begin::Action-->
						<div class="text-center">
							<a href="logout" class="btn btn-primary btn-lg fw-bolder">Sign In</a>
						</div>
						<!--end::Action-->
						<!--begin::Action-->
