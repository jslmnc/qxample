			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
					...
					<a href="" class="mb-10 pt-lg-10">
						<img alt="Logo" src="assets/media/logos/overflowlogo.png" class="h-40px mb-5" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					...
					<div class="pt-lg-10 mb-10">
						...
						<!--end::Logo-->
						<!--begin::Message-->
						<div class="fs-3 fw-bold text-muted">We have sent an email to
						<a  class="link-primary fw-bolder"><?php echo $_SESSION['email'] ?></a>
						<br />please follow a link to reset your password. 
						<br /><br>This password reset link will expire in 60 minutes. </div>
						<!--end::Message-->
						<!--begin::Action--></div>
						<div class="text-center mb-10" >
							<a type="submit" href="logout" class="btn btn-lg btn-primary fw-bolder">Sign in</a>
						</div>
						<!--end::Action-->
						<!--begin::Action-->
						<div class="fs-5">
							<span class="fw-bold text-gray-700">Did’t receive an email?</span>
							<a href="password-reset" class="link-primary fw-bolder">Resend</a>
						</div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
				...
				<div class="d-flex flex-center flex-column-auto p-10">
					...
					<div class="d-flex align-items-center fw-bold fs-6">
						...
						<a href="mailto:overflowgroup.ph@gmail.com" class="text-muted text-hover-primary px-2">Contact</a>
						<a href="landing" class="text-muted text-hover-primary px-2">Contact Us</a>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
