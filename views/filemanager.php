								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted">
											<a href="../../Overflow/views/index.html" class="text-muted text-hover-primary">File Manager</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Folders</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark"> Folders List</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="card-header pt-10">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column">
												...
												<span class="mx-3">|</span><?php echo sizeFormat(folderSize($folder_name));?> used out of <?php echo sizeFormat(($limit));?>
									...
									<div class="card-body pb-0">
										...
										<div class="d-flex overflow-auto h-55px">
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
												...
												<!--begin::Nav item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary me-6" href="filesettings">Settings</a>
												</li>
												<!--end::Nav item-->
											</ul>
										</div>
									...
									<div class="card-header pt-8">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
												...
												<!-- $folder = array_filter(scandir('../files/')); if(count($folder) > 0) { foreach($folder as $name) { echo $name; //	echo (count(scandir($name)) - 2); //	echo sizeFormat($folder); } }end::Export-->
												<!--begin::Add customer-->
												...
												?>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<a href="#" class="text-gray-800 text-hover-primary"><?php echo $name ?></a>
														</div>
													</td>
													<!--end::Name=-->
													<!--begin::Size-->
													<td><?php echo filesize('../files/user/'.$_SESSION['userid'].'/user_files/'.$name)?></td>
													<!--end::Size-->
													<!--begin::Last modified-->
	...
	<tr>
													...
													<td data-order="account">
														<div class="d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<a href="files" class="text-gray-800 text-hover-primary"><?php echo $name?></a>
														</div>
													</td>
													<!--end::Name=-->
													<!--begin::Size-->
								...
								<div class="d-none" data-kt-filemanager-template="rename">
									<div class="fv-row">
										<div class="d-flex align-items-center">
											...
											<input type="text" id="kt_file_manager_rename_input" name="rename_folder_name" placeholder="Enter the new folder name" class="form-control mw-250px me-3" value="" /></form>
