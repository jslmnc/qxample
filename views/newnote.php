...
function getid($dbh,$title,$notecontent){

	$sql="SELECT * FROM note WHERE notetitle=:notetitle AND notecontent=:notecontent";
	$query=$dbh->prepare($sql);
	$query->bindParam(':notetitle',$title,PDO::PARAM_STR);
	$query->bindParam(':notecontent',$notecontent,PDO::PARAM_STR);
	$query->execute();
	$results=$query->fetch(PDO::FETCH_ASSOC);
	if($query->rowCount()>0)
	{
...
$uid=substr(str_shuffle('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'),1,20);
$views=0;
$trash=0;
//$stat="private";
$sql="INSERT INTO note(userid,uid,notetitle,notecontent,stat,views,shareid,trash)VALUES(:userid,:uid,:notetitle,:notecontent,:stat,:views,:shareid,:trash)";
$query=$dbh->prepare($sql);
$query->bindParam(':userid',$user,PDO::PARAM_STR);
$query->bindParam(':notetitle',$title,PDO::PARAM_STR);
...
$query->bindParam(':shareid',$sid,PDO::PARAM_STR);
...
$idp=getid($dbh,$title,$text);


header("location: editnote?id=".$idp."");
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted">
											<a href="../../Overflow/views/index.html" class="text-muted text-hover-primary">My Notes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Trash Notes</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Trash Notes List</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
											...
											<div class="card-body">
												...
												<div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
													...
													<path opacity="0.3" d="M21.2 17.3C21.4 17.9 21.2 18.5 20.8 18.9L18 21.6C15.8 19.4 15.1 12.8 15.8 7.8C18.3 7.4 20.4 6.70001 21.5 5.60001C20.4 7.00001 20.2 14.5 21.2 17.3ZM8 11.7C8 9 7.7 4.2 5.5 2L2.8 4.8C2.4 5.2 2.2 5.80001 2.4 6.40001C2.7 7.40001 3.00001 9.2 3.10001 11.7C3.10001 15.5 2.40001 17.6 2.10001 18C3.20001 16.9 5.3 16.2 7.8 15.8C8 14.2 8 12.7 8 11.7Z" fill="currentColor"></path>
															...
															<span class="badge badge-light-success">		<?php
															$trashs=0;
												...
												<form method ="post"id="kt_inbox_compose_form" >
													...
													<div class="d-block">
														...
														<div class="d-flex align-items-center border-bottom px-8 min-h-50px">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" class="form-control form-control-transparent border-0" name="compose_to" value="" data-kt-inbox-form="ttagify" />
															<!--end::Input-->
														...
														<div class="border-bottom">
															<input class="form-control form-control-transparent border-0 px-8 min-h-45px"  class="title"name="title" placeholder="Title" />
														</div>
														<!--end::Subject-->
													...
													<div class="d-flex flex-stack flex-wrap gap-2 py-5 ps-8 pe-5 border-top">
														...
														<div class="form-check form-switch form-check-custom form-check-solid me-10">
															<input class="form-check-input h-30px w-50px" name="stat" type="checkbox" value="1" id="stat" />
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y pt-0 pb-15">
						...
						<div class="mw-lg-600px mx-auto">
							...
							<div class="mb-10">
								<!--begin::Title-->
								<h4 class="fs-5 fw-bold text-gray-800">Share link with friends</h4>
								<!--end::Title-->
								<!--begin::Title-->
								<div class="d-flex">																												
