						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Plans</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Plan List</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search plan" />
											</div>
											<!--end::Search-->
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<!--begin::Input group-->
														<div class="mb-10">
															<label class="form-label fs-6 fw-bold">Cycle:</label>
											...
											<div class="d-flex justify-content-end align-items-center d-none" data-kt-user-table-toolbar="selected">
												...
												<button type="submit" class="btn btn-danger" id="all_delete"name="all_delete" data-kt-user-table-select="delete_selected">Delete Selected</button>
											</div>
											<!--end::Group actions-->
...
-->
															<form id="kt_modal_edit_user_form<?php echo htmlentities(($result->id))?>" enctype="multipart/form-data" class="form" action="#">
																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_user_header" data-kt-scroll-wrappers="#kt_modal_edit_user_scroll" data-kt-scroll-offset="300px">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="planname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Plan name" value="<?php echo htmlentities(($result->plan_name))?>" />
																		<!--end::Input-->
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<textarea type="text" name="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description" value="<?php echo htmlentities(($result->plan_desc))?>"><?php echo htmlentities(($result->plan_desc))?></textarea>
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		<label class="required fw-bold fs-6 mb-2">Note Limit</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" hidden name="planID" value="<?php echo htmlentities(($result->planID))?>" class="form-control form-control-solid mb-3 mb-lg-0"  />

																		<input type="number" name="notelimit" value="<?php echo htmlentities(($result->note_limit))?>" min="1" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Note limit"  />
																		<!--end::Input-->
																	</div>
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		<label class="required fw-bold fs-6 mb-2">Space Limit (mb)</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="number" name="spacelimit" min="1"value="<?php echo htmlentities(($result->space_limit))?>" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Space Limit"  />
																		<!--end::Input-->
																	</div>
																	
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		<label class="required fw-bold fs-6 mb-2">Cycle</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																	...
																	<div class="input-group input-group-solid flex-nowrap">
																		...
																		<div class="overflow-hidden flex-grow-1">
																			<select name="cycle"  class="form-select form-select-solid rounded-start-0 border-start "  data-hide-search="true" data-control="select2" data-placeholder="Select an option">
																				<option value="<?php echo (($result->cycle))?>"><?php echo (ucfirst($result->cycle))?></option>
																				<option value="monthly">Monthly</option>
																				<option value="free">Free</option>
																	...
																	<!--end::Solid input group style-->																		<!--end::Input-->
																	</div>
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="number" value="<?php echo htmlentities(($result->price))?>"  step='0.01' min="1.00" name="price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Price"  />
																		<!--end::Input-->
																	</div>
															...
															<form id="kt_modal_add_plan_form" class="form" >
																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<textarea type="text" name="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description" ></textarea>
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="number" name="notelimit"  min="1" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Note limit"  />
																		<!--end::Input-->
																	</div>
																	<div class="fv-row mb-7">
																		<!--begin::Label-->
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="number" name="spacelimit" min="1" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Space Limit"  />
																		<!--end::Input-->
																	</div>
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="number"  step='0.01' min="1.00" name="price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Price"  />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-100px">Note Limit</th>
													<th class="min-w-100px">Space Limit</th>
													<th class="min-w-100px">Cycle</th>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check form-check-sm form-check-custom form-check-solid">
															<input class="form-check-input" id ="ucheckbox"type="checkbox" data-u-id="<?php echo $result->id ?>" value=<?php echo htmlentities($result->id)?> />	
														</div>
													</td>
													...
													<!--begin::Last login=-->
													<td>
													<a href="viewplan?planID=<?php echo $result->planID?>" class="text-gray-800 text-hover-primary mb-1"><?php echo htmlentities(($result->plan_name))?></a>
													...
													<!--begin::Joined-->
													<td>
													<?php echo htmlentities($result->plan_desc)?>
													</td>
												
													
													<td>
													<?php echo htmlentities($result->note_limit)?>
													</td>
													<td>
													<?php echo htmlentities($result->space_limit)?>
													</td>
													<td>
														<?php if($result->cycle=="free"){?>
															<span class="badge badge-light-success"><?php echo htmlentities(ucfirst($result->cycle))?>
													<?php }else{?>
														<span class="badge badge-light-info"><?php echo htmlentities(ucfirst($result->cycle))?>
													...
													<td>
													<?php $date=$result->date; echo htmlentities(date('F j, Y, g:i a',strtotime($date)))?>
													</td>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="viewplan?planID=<?php echo $result->planID;?>" class="menu-link px-3">View</a>
															</div>


															<div class="menu-item px-3">
																<a  data-bs-toggle="modal" name="id11" id="<?php echo htmlentities($result->id);?>" data-bs-target="#kt_modal_edit_user1<?php echo htmlentities($result->id)?>" value ="<?php echo htmlentities($result->id)?>"   class="menu-link px-3 edit_data ">Edit</a>
															</div>
															<!--end::Menu item-->
															<!--begin::<input value=" < ?php echo htmlentities(($result->id))?>" > </input>Menu item-->
															<div class="menu-item px-3">


																<a href="#" onclick="deleteplan(<?php echo htmlentities($result->id);?>)" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete </a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
...
?>
		...
		<!--begin::Page Custom Javascript(used by this page)-->
			<!--begin:<script src="assets/js/custom/apps/user-management/users/list/table.js"></script>-->
		<!--begin::	<script src="assets/js/custom/apps/user-management/users/list/add.js"></script>-->
		...
		$(document).on('click','.edit_data',function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					//$('#kt_modal_edit_user').modal({'show':true});
...
$('.edit_data').click(function(){
  //  let id = $(this).data('id');
   ...
   // $('#myModal-'+id).modal('show')
 //  var elmId = $("#kt_modal_edit_user1").attr("id");
  //  alert(id);
...
$(document).ready(function(){
	...
	Swal.fire({
                    text: "Are you sure you want to delete selected plans?",
                    icon: "warning",
...
var KTEditUser = function () {
    ...
    const form = element.querySelector('#kt_modal_add_plan_form');
            ...
            form,
            {
                fields: {
                    'planname': {
                        ...
                        validators: {
							...
							stringLength: {
								min: 3,
							//	max: 40,
								message: 'The Plan name must be more than 3 characters long'
							},
						//	regexp: {
							//	regexp: /^[a-zA-Z0-9_\.]+$/,
							//	message: 'The Plan name can only consist of alphabetical, number, dot and underscore'
							//	},
						//	remote: {
							//	message: 'The Plan Name is already taken!',
							//	url: '_crud.php',
							///	data: function () {
                            //    return {
                            //        username: form.querySelector('[name="planname"]').value,
							//		action: 'plannamecheck',
					...
					'spacelimit': {
                        ...
                        validators: {
                            notEmpty: {
                                message: 'Space limit is required!'
                            },
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
							...
							var form=$('#kt_modal_add_plan_form')[0];
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
							...
							var formdata=new FormData(form);
							formdata.append('action', 'editplan');
