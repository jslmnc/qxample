						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">My Calendar</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">My Calendar</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
    ...
    var initCalendarApp = function () {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
			...
			events: [<?php while ($row = $query ->fetch_object()) { ?>{ 
					...
					id: '<?php echo $row->id; ?>',
					title: '<?php echo $row->calendar_event_name; ?>',
					start: '<?php echo $row->calendar_event_start_date .'T'. $row->calendar_event_start_time?>',
					end:  '<?php echo $row->calendar_event_end_date.'T'. $row->calendar_event_end_time?>',
					description: '<?php echo $row->calendar_event_description; ?>',
					className: "fc-event-danger fc-event-solid-warning",
					location: '<?php echo $row->calendar_event_location; ?>' 
			...
			//	description: '< ?php echo $row->notetitle; ?>',
			//	className: "fc-event-danger fc-event-solid-warning",
				//location: 'Federation Square' 
				}, 
				
				
				<?php } ?><?php while ($row = $query ->fetch_object()) { ?>{ 
				id: '<?php echo $row->id; ?>',
				title: '<?php echo $row->calendar_event_name; ?>',
				start: '<?php echo $row->calendar_event_start_date .'T'. $row->calendar_event_start_time?>',
				end:  '<?php echo $row->calendar_event_end_date.'T'. $row->calendar_event_end_time?>',
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
							...
							var form=$('#kt_modal_add_event_form')[0];
