									...
									<div class="col-md-4">
										...
										<div class="card card-flush h-md-100">
											...
											<div class="card-header">
												...
												<div class="fw-bolder text-gray">
													
											<h2><?php echo htmlentities(ucfirst(($result->rolename)));?></h2>
													
											hi this is a simple tez
										...
										<div class="fw-bolder text-gray-600 mb-5">
											...
											<!--end::Card body-->
											<!--begin::Card footer-->
											<div class="card-footer flex-wrap pt-0" align="right">
											<div class="fw text-gray-600">	<?php echo htmlentities((($result->date)));?>

										
															<button class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="right-end">
				...
				//	/^[A-Za-z]+$/
                    'rolename': {
                        validators: {
							...
							regexp: {
								regexp: /^[A-Za-z]+$/,
								message: 'Role name must be letters only!'
							},
							remote: {
                 ...
                 validator.validate().then(function (status) {
                     ...
                     if (status == 'Valid') {
                         ...
                         setTimeout(function () {
							 ...
							 var form=$('#kt_modal_add_role_form')[0];
...
$(document).ready(function(){
	$("#clickb").on("change", function(e) {
  	const isOn = e.currentTarget.checked;
    
    if (isOn) {
    	$("#toggle").hide();

		document.getElementById("changetext").innerHTML = "Private";

    } else {
    	$("#toggle").show();
		document.getElementById("changetext").innerHTML = "Public";
