						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3">
										<!--begin::Menu wrapper-->
										<a href="chat"class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggleg">
...
" alt="image" />
													...
													<div class="d-flex flex-column">
														<div class="fw-bolder d-flex align-items-center fs-5"><?php echo (ucfirst($result->fname)).' '.(ucfirst($result->lname)).''?>
														<span class="badge badge-light-primary fw-bolder fs-8 px-2 py-1 ms-2"><?php echo (ucfirst($result->role))?></span></div>
														<a href="#" class="fw-bold text-muted text-hover-primary fs-9"><?php echo (($result->email))?></a>
													</div>
...
?>
											...
											<div class="menu-item px-5">
												<a href="myaccount" class="menu-link px-5">My Profile</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
